...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.leeds.setStyleSheet("background-image: url(:/team images/leeds.png);")
        self.leeds.setText("")
        ...
        self.brighton.setStyleSheet("background-image: url(:/team images/brighton.png);")
        ...
        self.brentford.setStyleSheet("background-image: url(:/team images/brentford.png);")
        ...
        self.arsenal.setStyleSheet("\n""background-image: url(:/team images/arsenal.png);\n""")
        ...
        self.crystal_palace.setStyleSheet("background-image: url(:/team images/crystal palace.png);")
        ...
        self.leicester.setStyleSheet("background-image: url(:/team images/leicester.png);")
        ...
        self.man_united.setStyleSheet("background-image: url(:/team images/man united.png);")
        ...
        self.everton.setStyleSheet("background-image: url(:/team images/everton.png);")
        ...
        self.man_city.setStyleSheet("background-image: url(:/team images/man city.png);")
        ...
        self.liverpool.setStyleSheet("background-image: url(:/team images/liverpool.png);")
        ...
        self.fulham.setStyleSheet("background-image: url(:/team images/fulham.png);")
        self.fulham.setText("")
        ...
        self.bournemouth.setStyleSheet("background-image: url(:/team images/bournemouth.png);")
        ...
        self.aston_villa.setStyleSheet("background-image: url(:/team images/aston villa.png);")
        ...
        self.chelsea.setStyleSheet("background-image: url(:/team images/chelsea.png);")
        ...
        self.nottingham.setStyleSheet("background-image: url(:/team images/nottingham.png);")
        ...
        self.wolves.setStyleSheet("background-image: url(:/team images/wolves.png);")
        self.wolves.setText("")
        ...
        self.southampton.setStyleSheet("background-image: url(:/team images/southampton.png);")
        ...
        self.newcastle.setStyleSheet("background-image: url(:/team images/newcastle.png);")
        ...
        self.spurs.setStyleSheet("background-image: url(:/team images/spurs.png);")
        self.spurs.setText("")
        ...
        self.west_ham.setStyleSheet("background-image: url(:/team images/west ham.png);")
